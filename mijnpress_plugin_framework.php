    ...
    */
    function addPluginContent($filename,$links, $file, $config_url = NULL)
    {
        if($file == $filename)    
        {
            ...
            $links[] = '<a href="http://sammelasoftware.wordpress.com/donate/">' . __('Donate') . '</a>';
            $links[] = '<a href="http://sammelasoftware.wordpress.com/plugin-support/">' . __('Support') . '</a>';
            $links[] = '<a href="http://sammelasoftware.wordpress.com">' . __('Custom WordPress coding') . '</a>';
        }
        return $links;
    }
    ...
    function content_end()
    {
        if($this->showcredits)
        {
        	echo '<br/><br/>Do you like this plugin? <a href="http://sammelasoftware.wordpress.com/donate/">PayPal Donations</a> (even as small as $1,- or &euro;1,- are welcome!.';
        }
        echo '</div>';
...
?>
    <div class="postbox">
        ...
        <div class="inside">
            This plugin was created by Sam Mela.  He is working on a high quality affordable national trucking meal delivery system.
            <br/><br/>Visit his website at: <a href="http://18mealer.com">18mealer.com</a><br/>
If you are a coder, you might like to visit <a href="http://www.ramonfincken.com/tag/wordpress.html">his WordPress blogposts</a>.
<br/><br/><a href="http://sammelasoftware.wordpress.com/plugin-support/">Is this plugin broken? Report it here</a>            
        </div>
    </div>
